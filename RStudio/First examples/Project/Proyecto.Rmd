...
readBeforeCovid<-function(){
  ...
  baseDatos<-NULL
  if(file.exists(paths = "BaseDatosCovid.xlsx")){#Valida que el archivo exista
    baseDatos<-read_xlsx(path = "BaseDatosCovid.xlsx",sheet = "BeforeCovid")
    baseDatos$...1<-NULL
  }
  return(baseDatos)
}
...
```{r message=FALSE, warning=FALSE, include=FALSE}
#Fechas<-seq(ymd("2019-11-01"),ymd("2020-03-05"),by="day")
...
#write.xlsx(x=BaseDatos,file = "BaseDatosCovid.xlsx",sheetName = "BeforeCovid",append = TRUE)
```
